...
EXEC AddClub 'RBAS', 'Really Bad Archiecture Society'
...
--5. Create a stored procedure called ‘RegisterStudent’ that accepts StudentID and OfferingCode as
--parameters. If the number of students in that Offering is not greater than the Max Students for
--that course, add a record to the Registration table and add the cost of the course to the
--student’s balance. If the registration would cause the Offering to have greater than the
