...
--3. Select the CourseIds and CourseNames of all the courses. Use the column aliases of Course ID and Course Name
...
--13. Select Student Names, Street Address, and City where the lastName is exactly 3 letters long.
